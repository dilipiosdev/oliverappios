...
class FilesDePersonalViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, SettingButtonProtocol {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0 {
            ...
            cell.titleLbl.text = "Files de personal:"
            cell.descriptionLbl.text = "Registra la informacion de tus trabajadores."
            return cell
    ...
    func settingButtonTapped(indexPath: IndexPath) {
        ...
        let nextViewController = storyBoard.instantiateViewController(withIdentifier: "FilesDeDetailsViewController") as! FilesDeDetailsViewController

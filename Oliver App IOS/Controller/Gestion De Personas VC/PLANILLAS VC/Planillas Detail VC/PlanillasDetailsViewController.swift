...
class PlanillasDetailsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let controller1 = storyBoard.instantiateViewController(withIdentifier: "BoltaDeOptionViewController") as! BoltaDeOptionViewController
            controller1.title = "BOLETA DE PAGO"
    ...
    @IBAction func buttonBack(_ sender: Any) {
        ...
        UserDefaults.standard.setValue(nil, forKey: "INGRESOS")
        UserDefaults.standard.setValue(nil, forKey: "DESCUENTOS")

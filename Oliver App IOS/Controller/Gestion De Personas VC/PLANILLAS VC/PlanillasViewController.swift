...
class PlanillasViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, SettingButtonProtocol {
    ...
    func settingButtonTapped(indexPath: IndexPath) {
        ...
        let nextViewController = storyBoard.instantiateViewController(withIdentifier: "PlanillasDetailsViewController") as! PlanillasDetailsViewController

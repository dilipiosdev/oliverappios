...
class PerfileDetailsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let controller1 = storyBoard.instantiateViewController(withIdentifier: "PerfileOptionViewController") as! PerfileOptionViewController
            controller1.title = "PERFIL"
            ...
            controller2.title = "COORDINACIONES"

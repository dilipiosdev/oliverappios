...
class NormatividadAmbientalViewController: UIViewController , UITableViewDataSource, UITableViewDelegate, YesNoButtonSetProtocol{
    ...
    override func viewDidLoad() {
        ...
        self.titleArray = ["","Política Nacional de Salud Ambiental", "Impacto Ambiental", "Calidad Ambiental - Ruido", "Calidad Ambiental - Aire", "Industria Manufacturera y Comercio Interno (intermediarios sin transformación del producto final)", "Panificación, Galletería y Pastelería"]
        
        self.especificationArray = ["","Establecer la Política Nacional de Salud Ambiental que fortalezca la prevención y el control de riesgos sanitarios ambientales relacionados a los daños a la salud de los ciudadanos, en el marco del proceso de descentralización de la salud, así como su gestión.", "Establecimiento de un proceso uniforme que comprenda los requerimientos, etapas, y alcances de las evaluaciones del impacto ambiental de proyectos de inversión y establecimiento de los mecanismos que aseguren la participación ciudadana en el proceso de evaluación de impacto ambiental.", "Estándares nacionales de calidad ambiental para el ruido y los lineamientos para no excederlos, con el objetivo de proteger la salud, mejorar la calidad de vida de la población, y promover el desarrollo sostenoble.", "Establece los estándares nacionales de calidad ambiental del aire y los lineamientos de estrategia para alcanzarlos progresivamente. ", "Promover y regular la gestión ambiental, la conservación y aprovechamiento sostenible de recursos naturales en el desarrollo de las actividades de la industria manufacturera y de comercio interno, así como regular los instrumentos de gestión ambiental, los procedimientos y medidas de protección ambiental aplicables a éstas. ", "Norma sanitaria tiene como propósito proteger la salud de los consumidores, disponiendo los requisitos sanitarios que deben cumplir los productos de panificación, galletería y pastelería y los establecimientos que los fabrican, elaboran y expenden."]
        
        self.decrtoArray = ["","RM 258-2011 / MINSA", "Ley 27446", "DS 085-2003-PCM", "DS 074-2001 - PCM", "DS 074-2001 - PCM", "DS 017-2015-PRODUCE"]
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0 {
            ...
            cell.titleLbl.text = "Normatividad Ambiental"
            cell.descriptionLbl.text = "¿Qué debes de tener en cuenta para cumplir tus obligaciones ambientales o las de tu comercio/negocio/empresa?"
            return cell
    ...
    //MARK-: YES No Button delegate Methods
            func yesNoButtonTapped(yesnoStr: Int, indexPath: IndexPath) {
                ...
                Database.database().reference().child("My Companies").child(self.companyId).child("Normativity")
                    .child("Environmental").updateChildValues(dict)
                self.getProductList()
            }

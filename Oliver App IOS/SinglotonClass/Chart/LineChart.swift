...
class LineChart: UIView {
    ...
    private func setupView() {
        ...
        gradientLayer.colors = [#colorLiteral(red: 0.1019607857, green: 0.2784313858, blue: 0.400000006, alpha: 0.3137675911).cgColor, UIColor.clear.cgColor]
    ...
    private func drawHorizontalLines() {
        ...
        if let gridValues = gridValues {
            for value in gridValues {
                ...
                textLayer1.frame = CGRect(x: UIScreen.main.bounds.width - 96, y: height, width: 50, height: 16)
                textLayer1.foregroundColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1).cgColor
                textLayer1.backgroundColor = UIColor.clear.cgColor
                textLayer1.contentsScale = UIScreen.main.scale
                textLayer1.font = CTFontCreateWithName(UIFont.systemFont(ofSize: 0).fontName as CFString, 0, nil)
                textLayer1.alignmentMode = .right
                textLayer1.fontSize = 12
                textLayer1.string = "\(lineValue)"
                gridLayer.addSublayer(textLayer1)
            }
        }
    }
    ...
    private func drawDots() {
        ...
        if let dataPoints = dataPoints {
            for dataPoint in dataPoints {
                ...
                dotLayer.dotInnerColor = #colorLiteral(red: 0.1019607857, green: 0.2784313858, blue: 0.400000006, alpha: 1)
